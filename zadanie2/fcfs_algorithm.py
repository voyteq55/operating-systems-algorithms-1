...
class FCFSAlgorithm(algorithm.Algorithm):

    def __init__(self, requests, initial_disk_head_position, max_disk_capacity, real_time_requests_strategy=None):
        super().__init__(requests, initial_disk_head_position, max_disk_capacity, real_time_requests_strategy)
